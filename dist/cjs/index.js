...
exports.SyncWorkerHandler = exports.SyncWorker = exports.SyncWorkerJSONSerializer = exports.DEFAULT_NAMESPACE = exports.SyncWorkerError = void 0;
class SyncWorkerError extends Error {
}
exports.SyncWorkerError = SyncWorkerError;
exports.DEFAULT_NAMESPACE = "$SyncWorker";
class SyncWorkerJSONSerializer {
...
exports.SyncWorkerJSONSerializer = SyncWorkerJSONSerializer;
;
class SyncWorker {
    postMessage;
    buffer;
    ...
    constructor(postMessage, option) {
        ...
        this.namespace = option?.namespace ?? exports.DEFAULT_NAMESPACE;
...
exports.SyncWorkerHandler = SyncWorkerHandler;
